...
class TopResumeListCell: UICollectionViewCell {
    ...
    var userData: UserData? {
        didSet {
           ...
           if userData.type == .coverLetter  {
            ...
            let nameLabelAttributedText = NSAttributedString(string: fullName.capitalized, attributes: [.font : UIFont(name: Theme.nunitoSansSemiBold, size: 18) as Any])
    ...
    let moreButton: UIButton = {
        ...
        if #available(iOS 15.0, *) {
            ...
            button.contentEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 8, right: 10)
        }
    ...
    override init(frame: CGRect) {
        ...
        if #available(iOS 14.0, *) {
            ...
            let interation = UIContextMenuInteraction(delegate: self)
            moreButton.addInteraction(interation)
        }
...
extension TopResumeListCell:UIContextMenuInteractionDelegate {
...
extension TopResumeListCell: ContextMenu {
